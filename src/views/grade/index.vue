<template>
  <div class="app-container">
    ...
    <div style="margin-left:15%;margin-top:10px">
      ...
      <el-button type="primary" @click="onSubmit()">添加班级</el-button>
      <el-table
    ...
    <el-dialog title="新建班级" :visible.sync="dialogFormVisible">
      <el-form :model="teams">
        <el-form-item label="班级名称">
          <el-input v-model="teams.teamName" placeholder="请输入名称"></el-input>
        </el-form-item>
        <el-form-item label="班级人数">
          <el-input v-model="teams.studentNum" placeholder="请输入学生人数"></el-input>
        </el-form-item>
        <el-form-item label="班级容量">
          <el-input v-model="teams.capacity" placeholder></el-input>
        </el-form-item>
        <el-form-item label="课程名称">
          <el-input v-model="teams.courseName"></el-input>
        </el-form-item>
...
export default {
  ...
  computed: {
    filterData() {
      return this.teams.filter(item => {
        ...
        return !this.searchStr || reg.test(item.teamName);
      });
    }
  },
  created() {
  ...
  methods: {
    ...
    classAdd() {
      ...
      let { teamName, studentNum, image, capacity, courseName } = studentList;
      //判断数据是否为空
      if (
        teamName == "" ||
        studentNum == "" ||
